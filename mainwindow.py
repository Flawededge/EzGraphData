...
class Ui_plotGui(object):
    def setupUi(self, plotGui):
        ...
        self.groupBox.setGeometry(QtCore.QRect(400, 50, 169, 96))
        ...
        self.specialMult = QtWidgets.QDoubleSpinBox(plotGui)
        self.specialMult.setGeometry(QtCore.QRect(100, 380, 91, 22))
        self.specialMult.setCorrectionMode(QtWidgets.QAbstractSpinBox.CorrectToNearestValue)
        self.specialMult.setDecimals(4)
        self.specialMult.setMaximum(1000.0)
        self.specialMult.setSingleStep(0.0001)
        self.specialMult.setProperty("value", 3.3946)
        self.specialMult.setObjectName("specialMult")
