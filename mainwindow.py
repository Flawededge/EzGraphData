...
class Ui_plotGui(object):
    def setupUi(self, plotGui):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(640, 200, 374, 301))
        ...
        self.leftForm.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.label)
        self.label_2 = QtWidgets.QLabel(self.horizontalLayoutWidget)
        self.label_2.setObjectName("label_2")
        self.leftForm.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.label_2)
    ...
    def retranslateUi(self, plotGui):
        ...
        self.label.setText(_translate("plotGui", "The stuff out here is in various levels of disrepair"))
        self.label_2.setText(_translate("plotGui", "This area is for blue seas, but isn\'t currently functional"))
        self.adjustedChargeEfficiency.setText(
            _translate("plotGui", "Use adjusted charge efficiency (Not really doing a lot)"))
